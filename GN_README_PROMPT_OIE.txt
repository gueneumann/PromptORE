...
- First:
    - test with FewRel
        - get sentences for found clusters, e.g., using FewRel
        - DONE, even get phrase between NE pair

- Second:
    - Create promptORE formatted object from OIE triples
        - how to identify and represent relation-type ?
        - I could simply use OIE as a dummy label
        - should work upto clustering
    - Use sent_id to be able to align extractions from same sentence
    - I can adapt 
