...
TODO Testing full FewRel (56000 sentences/extractions):
...
Paper:
promptOre   B3 = 48.8,  V-measure = 78.071,8,   ARI = 43.4

SelfORE:    B3 = 53.9,  V-measure = 73.2,   ARI = 51.7
(Results from ASCORE using only first 40 relations)
...
Paper:
PromptOre:  B3 = 65.2,  V-measure = 78.0,   ARI = 56.9
